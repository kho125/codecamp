...
export const Comment__p = styled.div`
  font-weight: 500;
  font-size: 18px;
  line-height: 27px;
  margin-left: 14px;
...
export const Name__Password = styled.div`
  margin-bottom: 20px;
`;
...
export const Comment__Input = styled.input`
  width: 100%;
  height: 108px;
  border: 1px solid #bdbdbd;
...
export const Comment__bottom = styled.div`
  width: 100%;
  height: 52px;
  border: 1px solid #bdbdbd;
...
//12037409123794801238904792317095ru12
